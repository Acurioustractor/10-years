...
export const PEOPLE: Person[] = [
  ...
  // ─── Mick Miller (post-strike voice, 1978 Tribune) ─────
  {
    slug: 'mick-miller',
    displayName: 'Mick Miller',
    status: 'historical-figure',
    birthDecadeApprox: '1940s',
    country: ['manbarra-wulgurukaba'],
    oneLine: 'Land-rights activist who grew up on Palm Island when the Aboriginals Protection Act "was even more vicious than it is today". His 1978 Tribune piece named Bill Congoo as a strike leader, named his own uncle as a strike leader, and recorded the strike-era discipline — the curfew bell, jail for being out after 10, weekly-dance punishments, escapees bashed and imprisoned without trial.',
    keyConnections: ['bill-congoo', 'frank-anderson'],
    connectedEventIds: ['1957-magnificent-seven'],
    connectedPlaceSlugs: ['palm-island'],
    sources: ['trove-260214551'],
    culturalSensitivity: 'public',
  },
  ...
  // ─── Aunty Dulcie Isaro (named in Trove findings, contemporary writer) ─────
  {
    ...
    status: 'living',
    birthDecadeApprox: '1940s',
    country: ['manbarra-wulgurukaba', 'girramay'],
    oneLine: 'Daughter of Willie Thaiday (Magnificent Seven 1957) and Madge Thaiday (Girramay, Tully). Author of *The Day Palm Island Fought Back*. Sister to Mick Thaiday. The family-side written record of the 1957 dawn raid.',
    keyConnections: ['willie-thaiday', 'madge-thaiday', 'mick-thaiday', 'frank-anderson'],
    connectedEventIds: ['1957-magnificent-seven'],
    connectedPlaceSlugs: ['palm-island', 'tully'],
    sources: ['isaro-day-palm-fought-back', 'trove-255498051'],
    culturalSensitivity: 'public',
  },
  {
    slug: 'mick-thaiday',
    displayName: 'Uncle Mick Thaiday',
    status: 'ancestor',
    birthYear: 1952,
    deathYear: 2010,
    birthDecadeApprox: '1950s',
    country: ['manbarra-wulgurukaba'],
    oneLine: 'Ninth child of Willie and Madge Thaiday. Brother to Aunty Dulcie Isaro. Elected Palm Island Councillor 15 March 2008. Pioneer of TAIMA / 4K1G FM Indigenous radio. Carried the strike-line forward into council-era Palm.',
    keyConnections: ['willie-thaiday', 'madge-thaiday', 'aunty-dulcie-isaro'],
    connectedEventIds: ['1957-magnificent-seven'],
    connectedPlaceSlugs: ['palm-island'],
    sources: ['trove-255498051'],
    culturalSensitivity: 'public',
  },
  {
    slug: 'madge-thaiday',
    displayName: 'Madge Thaiday',
    status: 'ancestor',
    birthDecadeApprox: '1920s',
    country: ['girramay'],
    oneLine: 'Girramay woman from Tully. Wife of Willie Thaiday (Magnificent Seven). Mother of Aunty Dulcie Isaro and Uncle Mick Thaiday. Carried the Tablelands line into the Thaiday family on Palm.',
    keyConnections: ['willie-thaiday', 'aunty-dulcie-isaro', 'mick-thaiday'],
    connectedEventIds: [],
    connectedPlaceSlugs: ['girramay', 'tully', 'palm-island'],
    sources: ['trove-255498051'],
    culturalSensitivity: 'public',
  },
  // ─── Rachel Wilson (1981 Canberra speech) ─────
  {
    slug: 'rachel-wilson',
    ...
    birthDecadeApprox: '1930s',
    country: ['manbarra-wulgurukaba'],
    oneLine: 'Bwgcolman elder. In 1981 she travelled to Canberra to address the Commonwealth on behalf of Palm Island, asking that all Queensland reserves be returned with freehold title. The voice "we feel this is our home" entered the period press.',
    keyConnections: [],
    connectedEventIds: ['1981-our-home'],
    connectedPlaceSlugs: ['palm-island'],
    sources: ['canberra-times-1981'],
    culturalSensitivity: 'public',
  },
  // ─── Uba (Halifax 1934 South Sea Islander elder) ─────
  {
    slug: 'uba',
    displayName: 'Uba',
    status: 'ancestor',
    birthDecadeApprox: '1840s',
    deathYear: 1934,
    country: ['halifax-hinchinbrook'],
    oneLine: 'South Sea Island woman. Lived in the Cordelia district. Left "the island" in 1884 during the peak of Polynesian indenture, age 55. Buried at Halifax in January 1934 around age 105 — "probably the oldest resident, in the matter of age, in the district". A documented community elder of the Halifax Camp South Sea Islander ground; possible ancestor-generation connection to Aunty Ethel + Aunty Iris pending family confirmation.',
    keyConnections: ['aunty-ethel-robertson', 'aunty-iris-whitey'],
    connectedEventIds: [],
    connectedPlaceSlugs: ['halifax-hinchinbrook'],
    sources: ['trove-172783148'],
    culturalSensitivity: 'consent-required',
  },
...
export const ANCHOR_YEARS: AnchorYear[] = [
  ...
  },
  {
    ...
    significance: 'The Magnificent Seven strike. Five days against working conditions, unpaid wages, and the Aboriginals Protection Act. Ended in dawn raids — chains, leg irons, families forcibly removed. Six men plus two wives held at Townsville watch-house. Cherbourg for Congoo, Watson, Lymburner; Wooroobinda for Sibley, Geia, Thaiday.',
    connectedPersonSlugs: ['albie-geia', 'willie-thaiday', 'eric-lymburner', 'sonny-sibley', 'bill-congoo', 'george-watson', 'gordon-tapau', 'frank-anderson', 'aunty-dulcie-isaro', 'mick-thaiday', 'madge-thaiday', 'mick-miller'],
    connectedEventIds: ['1957-magnificent-seven'],
    connectedPlaceSlugs: ['palm-island', 'woorabinda', 'cherbourg', 'townsville'],
  },
  {
    year: 1971,
    yearLabel: '1971',
  ...
  },
  {
    year: 1934,
    yearLabel: '1934',
    significance: 'Uba — South Sea Island woman of the Halifax Camp era, around 105 years old — is buried at Halifax. "Probably the oldest resident, in the matter of age, in the district." A documented community elder of the South Sea Islander ground that the Robertson + Whitey family lines run through.',
    connectedPersonSlugs: ['uba'],
    connectedEventIds: [],
    connectedPlaceSlugs: ['halifax-hinchinbrook'],
  },
  {
    year: 1981,
    yearLabel: '1981',
    significance: 'Alf Palmer dies age 90. Rachel Wilson of Palm Island addresses parliament in Canberra: "We feel this is our home." A rare named Bwgcolman first-person voice in the period press, recorded as the Bjelke-Petersen Aboriginal Acts head toward repeal.',
    connectedPersonSlugs: ['alf-palmer', 'rachel-wilson'],
    connectedEventIds: ['1981-our-home'],
    connectedPlaceSlugs: ['palm-island', 'warrongo'],
  },
  {
...
export const ELDER_LINEAGES: ElderLineage[] = [
  ...
  },
  {
    ...
    ancestors: [
      { personSlug: 'uba', relation: 'great-great-grandmother', confidence: 'inferred', notes: 'South Sea Island woman buried at Halifax 1934, around 105 years old. Cordelia district. Left her island in 1884 during the peak of Polynesian indenture. The exact place and period of the Robertson/Whitey family ground — candidate ancestor-generation marker, for deeper discussion with the family.' },
    ],
    kin: [
    ...
    notes: 'South Sea Islander origin (Erromango / Manga spelling pending) and Robertson + Whitey family-line names beyond Aunty Iris still being walked. Uba 1934 added as candidate ancestor-generation marker for deeper discussion.',
  },
  {
    elderSlug: 'aunty-iris-whitey',
    ancestors: [
      { personSlug: 'uba', relation: 'great-great-grandmother', confidence: 'inferred', notes: 'Same Halifax 1934 SSI elder as Aunty Ethel — candidate ancestor-generation marker.' },
    ],
    kin: [
      { personSlug: 'aunty-ethel-robertson', relation: 'sibling', confidence: 'confirmed' },
    ],
    notes: 'Same line as Aunty Ethel.',
  },
  {
