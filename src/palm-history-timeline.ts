...
export const EVENT_SLOTS: EventSlot[] = [
  ...
  },
  {
    ...
    body: 'Seven Palm Island men declared a strike against working conditions and unpaid wages — Sonny Sibley, William Congoo, George Watson Jr, Eric Lymburner, Albie Geia, Willie Thaiday, Gordon Tapau. Sibley was a fitter paid 30 shillings a week with seven children. The strike lasted five days. It ended in dawn raids — chains, leg irons, families forcibly removed. Six men plus two wives held at Townsville watch-house with no charges or legal advice. Cherbourg for Congoo, Watson, Lymburner; Wooroobinda for Sibley, Geia, Thaiday. Frank Anderson was seventeen on Palm. He saw it.',
  ...
  },
  {
    ...
    year: 1981,
    yearLabel: '1981',
    eyebrow: 'Rachel Wilson · Canberra',
    heading: 'We feel this is our home',
    body: "Rachel Wilson of Palm Island travelled to Canberra with four other Aboriginal Queenslanders to address the Commonwealth. They asked that all Queensland reserves be returned with freehold title when Bjelke-Petersen's Aboriginal Acts were repealed. Rachel's voice in that meeting — recorded in Canberra Times 1981 — is one of the rare named Bwgcolman first-person voices in the period press. The Protection Act era is closing. The next generation of community leadership is naming what comes after.",
    pullquote: "We feel this is our home. We've had our families here, we've grown up here.",
    attribution: 'Rachel Wilson · Palm Island · ANU Aboriginal Support Group meeting, Canberra 1981',
    bg: IMG.athertonTableland1954,
    connectedClusters: [],
    connectedElders: [],
    wikiSource: 'wiki/events/1981-our-home.md',
  },
  {
