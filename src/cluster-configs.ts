...
export const CLUSTER_CONFIGS: Record<string, ClusterConfig> = {
  'palmer-burns-obah': {
    ...
    chapters: [
      ...
      {
        eyebrow: 'Language regret',
        heading: 'I should have listened to my mother',
        body: "Lizzie Palmer tried to teach her daughter the language. The daughter — Marjoyie's mother — refused as a girl. She wanted to play with her cousins, not sit and learn. She came back to it as a woman with regret. The line is the cluster's plain account of how language loss runs through three generations.",
        pullquote: "She was, uh, a young girl that want to play all the time with their cousins. Her mother was trying to teach her how to talk, but my mother didn't wanna learn how to talk. All she wanted to do just play. And, uh, she regretted when she came a woman. She said, I should have listened to my mother at that time.",
        attribution: 'Marjoyie Burns · Elders Trip Interview',
        bg: BG.dancers1931,
      },
      {
        eyebrow: '1971',
        heading: 'When the law broke',
        body: "Marjoyie names the moment her life shifted out of the Aboriginals Protection Act and into citizenship. The 1971 abolition of the Act in Queensland. Her phrase — 'the law broke' — is how the cluster carries the change.",
        pullquote: "Until we become women of our own self, men and women. And then everything sort of changed then, and that's where the law broke then, and everything just went to normal, you know, we were treated equal.",
        attribution: 'Marjoyie Burns · Elders Trip Interview',
        bg: BG.brassBand1931,
      },
      {
        eyebrow: 'Trumpet',
        heading: 'He\'d walk right down the road',
        body: "Allison Obah played trumpet on Palm. When the bands played, he walked right down the road playing his own. After he and Daisy married at Yarrabah and were sent to Palm to clear land, he built the family house at the base of Mount Bentley and planted mango trees. The trumpet, the mangoes, the bay-side house — what the family carries to remember him by.",
        pullquote: "The grand that Ellison was. Trumpet, uh, thing, whatever. Yeah, he played that. Wow. Um, really well. And he'd walk right down the road when the bands playing.",
        attribution: 'Winifred Obah · Elders Trip Interview',
        bg: BG.palmIsland1928,
      },
      {
        eyebrow: '100-year anniversary',
        heading: 'Five minutes nonstop',
        body: "In 2018 the Palm Island community marked the centenary of the 1918 Hull River cyclone — the storm that drove their grandparents and great-grandparents to Bwgcolman. The corroboree on Palm ran five minutes nonstop. The hundred-year mark.",
        pullquote: "We had our hundred year anniversary, it was in 2018. True. You know, when they did all the corroboree in there for five minutes nonstop.",
        attribution: 'Winifred Obah · Elders Trip Interview',
        bg: BG.dancers1931,
      },
    ],
  ...
  'ethel-iris-family': {
    ...
    chapters: [
      ...
      {
        eyebrow: '1940 babies',
        heading: 'Born under the Act',
        body: "Ethel and Iris are sisters, born in 1940. Two of seventeen children to the same Halifax-born father (Tom Curly, born Mga) and the same Stolen-Generation mother. The babies who came of age as the Aboriginals Protection Act was beginning to crack.",
        pullquote: "Because we're the 1940 babies.",
        attribution: 'Aunty Ethel Taylor Robertson · Ferdies Interview',
        bg: BG.palmIsland1928,
      },
      {
        eyebrow: 'Their father',
        heading: 'Tom Curly was born Mga',
        body: "Halifax-born. Sent to Palm Island as a young boy. The settlement renamed him Tom Curly because of his tight curly hair. The Aboriginal name his family carries — held alongside the settler-given one — is Mga.",
        pullquote: "My father's real name was Mga, but when he went to Palm Island as a young boy, they changed his name to Tom Curly. 'Cause he had tight, curly hair. Yeah, it was wrong.",
        attribution: 'Aunty Ethel Taylor Robertson · Lucinda Interview',
        bg: BG.palmIsland1928,
      },
      {
        eyebrow: 'Halifax tide',
        heading: 'Crab in the bathtub',
        body: "Before Palm, life on the Halifax tide. Tin bathtub, the tide running in and out, crabs everywhere. The salt-pan childhood of the people the 1919 wave swept up.",
        pullquote: "They used to live near the, like a, the tide used to come in and they used to just go in with big tin, uh, bathtub and just troll these crabs and crabs were just everywhere.",
        attribution: 'Aunty Ethel Taylor Robertson · Lucinda Interview',
        bg: BG.hinchinbrookChannel1935,
      },
      {
        eyebrow: 'The Charters Towers taxi',
        heading: 'I went to school with him in Ingham',
        body: "Decades later in Charters Towers, Aunty Ethel got into a taxi. The driver — Angelo Pori, an Italian-Australian — recognised the family name. He had been in Tom Curly's classroom in Ingham as a boy. Free lift home. The cane-field schoolyard kept its own ledger of who passed through.",
        pullquote: "He said, we went to school together over in Ham. I said, that's my father. He said, well, you're not gonna pay for the taxi, you're gonna get a free lift home.",
        attribution: 'Aunty Ethel Taylor Robertson · Lucinda Interview',
      ...
      {
        eyebrow: 'The Friday camp',
        heading: 'The only time she could speak language',
        body: "Aunty Iris remembers the camping trips around the bay every Friday afternoon — the only time their mother could speak her language. The Aboriginals Protection Act was inside the family yard. Out at the camp, with the children, she could be the woman she was raised to be.",
        pullquote: "Mom, you know, she took us camping every Friday afternoon. We'd stay around the bay. That's the only time she could speak their language.",
        attribution: 'Aunty Iris May Whitey · Ferdies Interview',
        bg: BG.palmCoconuts1935,
      },
      {
        eyebrow: 'The family of seventeen',
        heading: 'Fourteen who lived',
        body: "Seventeen children to the same parents. Fourteen lived to adulthood. Two brothers and one sister lost. The plain count Aunty Ethel keeps.",
        pullquote: "She ended up with only 14 because we lost two, two brothers and one sister then.",
        attribution: 'Aunty Ethel Taylor Robertson · Ferdies Interview',
        bg: BG.palmHappyMoments1935,
      },
      {
        eyebrow: 'Iris at fourteen',
        heading: 'Hospital, hookworms, runaway',
        body: "Aunty Iris finished grade four. Sent to the hospital to take worms out of soiled napkins so the doctor could see them. From there to a cattle station. The Stolen-Generation work pipeline running through the dormitory generation. She ran home.",
        pullquote: "I only went to grade four and I was sent straight down to the hospital. My job was to take the worms out of the napkins and put it in the bottle to show the doctor.",
        attribution: 'Aunty Iris May Whitey · Ferdies Interview',
        bg: BG.palmIsland1928,
      },
      {
  ...
  'allan-palm-island': {
    ...
    chapters: [
      ...
      {
        eyebrow: 'The stockman line',
        heading: 'All the way down to Ingham',
        body: "Allan's mother's family worked the stations near Mt Garnet. Stockmen and stockwomen on the cattle route. The cattle moved from the Tableland down through Ingham. The Aboriginal ringers were the labour holding the colonial pastoral economy. Allan's grandparents and great-grandmother were among them.",
        pullquote: "Bring all the cattle down from a top all the way down through. All down, all the way down to Ingham. Yeah. That's where they all traveled. Back up that way on all the ringers, they back in time.",
        attribution: 'Allan Palm Island · Elders Trip Interview',
        bg: BG.mtGarnet1901,
      },
      {
  ...
  'anderson': {
    ...
    chapters: [
      ...
      {
        eyebrow: 'Trouble',
        heading: 'I stayed in the park for a good while',
        body: "Between mainland work and New South Wales, Frank lived rough. The park-drinking years. Frank names them plainly — not edited, not softened. The brand-new-life chapter sits on the other side of this one.",
        pullquote: "I was in parks drinking. End up drinking. Drinking. Yeah. I stayed in the park for a good while. Yeah. And, uh, getting in in trouble.",
        attribution: 'Uncle Frank Daniel Anderson · Elders Trip Interview',
        bg: BG.palmIsland1928,
      },
      {
        eyebrow: 'New South Wales',
        heading: 'I behaved a lot better there',
        body: "Frank met a good girl in NSW and stayed there for years. The mainland chapter. He says it as plainly as he says the dormitory: this part of his life worked, that part didn't, the difference matters.",
        pullquote: "I went to Palm, then I met good girl in New South Wales. I went there, stayed a few years over there then. And, uh. I behaved a lot better there, you know, and, uh, I stayed in New South Wales for a long time.",
        attribution: 'Uncle Frank Daniel Anderson · Elders Trip Interview',
        bg: BG.victoriaMillIngham1935,
      },
      {
        eyebrow: 'Belonging',
        heading: 'You touch the water and the sand',
        body: "Goonyun Anderson, of the next generation, names what Country feels like. Fishing, hunting, water on skin. Embodied connection — the kind the dormitory generation had to fight to keep, the kind Goonyun's generation can practise without permission.",
        pullquote: "Like even when I go fishing, you know, you just feel more at home and, you know, you touch the water and the sand and whatnot. So, yeah, especially when you go hunting.",
  ...
  'mortoa-watson': {
    ...
    chapters: [
      ...
      {
        eyebrow: 'Two names, one woman',
        heading: 'Watson is what she calls herself',
        body: "Elsa speaks the surname Watson. She spells the surname Mortoa. Both are true. Mortoa is her stepfather Neville's surname — the name that ended up on the official paperwork. Watson is the name on her biological father's side, the kin line that runs to her cousin Winifred Obah and to the Watson cluster itself. The cluster carries both because she does.",
        pullquote: "My name is Elsa Watson, E-L-S-A-M-O-R-T-O-A.",
        attribution: 'Elsa Watson · Elders Trip Interview',
        bg: BG.palmIsland1928,
      },
      {
        eyebrow: 'The protective fact',
        heading: 'Mum came down with her parents',
        body: "Doreen Morton was a Mamu girl from Millaa Millaa Tablelands, sent to Palm Island at ten years old in the 1920s–30s removals. The fact Elsa names is the protective one: Doreen wasn't separated. Many Tablelands children were sent down alone, to strangers from another Country.",
        pullquote: "Lucky for mum, she came down with their parents, which is a good thing. You know, there was a lot of children that were sent down, they, oh no, what some stranger or somebody getting that's from that country, you know?",
        attribution: 'Elsa Watson · Elders Trip Interview',
        bg: BG.athertonTableland1954,
      },
      {
      ...
      {
        eyebrow: 'The historian',
        heading: 'Uncle John filled in the gaps',
        body: "Doreen and her parents did not pass on much oral history — silence was protective in their generation. Elsa's link to Mamu Country runs through her maternal uncle, Uncle John, who told the stories of where the family came from. The line that survived ran sideways through siblings, not straight down the parent-child path the Protection Act tried to break.",
        pullquote: "My grandparents didn't talk much about where they came from. It's just from mom's brother, uncle John. Later her on. He would tell us the stories of where they was from.",
        attribution: 'Elsa Watson · Elders Trip Interview',
        bg: BG.millaaMillaaFalls,
      },
      {
      ...
      {
        eyebrow: 'Mission-era childhood',
        heading: 'We lined up under a tree',
        body: "Elsa names the everyday infrastructure of the Aboriginals Protection Act on Palm Island. The morning routine: line up under a tree near the airport, walk in police-escorted formation to school. The ordinary fact of how a child got to class.",
        pullquote: "We used to line up there under a tree on the port or line up there and walk right around to the case man at the end of the airport.",
        attribution: 'Elsa Watson · Elders Trip Interview',
        bg: BG.palmIsland1928,
      },
      {
  ...
  'pryor-brear': {
    ...
    chapters: [
      ...
      {
        eyebrow: 'The name on the recording',
        heading: 'Del',
        body: "Cyndel signs her own name as Del. Cyndel is the registered form. Del is who she is in the room. Both belong on the page.",
        pullquote: "Del Louise Pryor. P-R-Y-O-R-P.",
        attribution: 'Cyndel Louise Pryor · Elders Trip Interview',
        bg: BG.bowenRiverHotel,
      },
      {
      ...
      {
        eyebrow: 'Hull River → Palm → Yuba',
        heading: 'Granddad was part of the whole river too',
        body: "Del names her paternal grandfather inside the 1918 Hull River dispersal — shipped to Palm with the survivors, then onward to Yarrabah. The same removal arc that runs through Allan Palm Island's family memory and through the Palmer · Burns · Obah cluster's Daisy Palmer. Three clusters intersect at this 1918 wave.",
        pullquote: "Granddad was part of the whole river too, where he was shipped to. He was involved in that and then they got, went to Yuba.",
        attribution: 'Cyndel Louise Pryor · Elders Trip Interview',
        bg: BG.palmIsland1928,
      },
      {
        eyebrow: 'The mother',
        heading: 'Grew up in the dormitory',
        body: "Del's mother was Stolen Generation. Raised in the dormitory on Palm Island from age five — her own mother Nelly died in 1937 when she was a child. The dormitory is where Del's mother met Del's father. The geography Del names: where the airport sits, the old school road, the old Catholic church.",
        pullquote: "Grew up in the dormitory on Palm Island where she married my father. Where the airport, uh, the old school road where the old Catholic church stands used to stand then.",
        attribution: 'Cyndel Louise Pryor · Elders Trip Interview',
        bg: BG.palmIsland1928,
      },
      {
        eyebrow: 'Ten children against loneliness',
        heading: 'She didn\'t want us to be lonely',
        body: "Del's mother had ten children — Del is the fifth. Two of the ten are still living. The mother's plain answer to her own Stolen-Generation childhood: a counter-erasure of family.",
        pullquote: "She ended up having 10 of us. She didn't want us to be lonely like she did.",
        attribution: 'Cyndel Louise Pryor · Elders Trip Interview',
        bg: BG.dancers1931,
      },
      {
        eyebrow: 'Crying at night',
        heading: 'I used to listen to her',
        body: "The image Del comes back to. Her mother sat down crying at night. Del listened. The intergenerational sound that shaped the search Del is now carrying for her.",
        pullquote: "I used to listen to her sit down and cry nighttime.",
        attribution: 'Cyndel Louise Pryor · Elders Trip Interview',
        bg: BG.bowenRiverHotel,
      },
      {
        eyebrow: 'Thirteen',
        heading: 'I became the mother',
        body: "Del's father Peter Pryor Junior died in 1971. She was thirteen. She became the mother to her last five siblings. Year-ten ended. The second-mother role she has played for fifty-five years.",
        pullquote: "When I turned 13, my dad died. So I became the mother of my last five siblings.",
        attribution: 'Cyndel Louise Pryor · Elders Trip Interview',
        bg: BG.palmIsland1928,
      },
      {
        eyebrow: 'The maternal blank',
        heading: 'Mom, mm nah',
        body: "Del names the asymmetry. Her father's family she knows. The Pryor (or Brear) line is intact — names, places, dates. Her mother's family is empty. The Guay-Tully-Murray-Nelly line. The gap she searches into.",
        pullquote: "Dad was okay. We knew his family, knew the history. But mom, mm nah.",
        attribution: 'Cyndel Louise Pryor · Elders Trip Interview',
        bg: BG.bowenRiverHotel,
      },
      {
      ...
      {
        eyebrow: 'The mission',
        heading: 'It keeps you going',
        body: "Del closes on the framing she carries forward. Not the search's completion. The search itself.",
        pullquote: "Like having a mission in life keeps you going, right? It does. It does.",
        attribution: 'Cyndel Louise Pryor · Elders Trip Interview',
        bg: BG.dancers1931,
      },
    ],
  ...
  'richardson': {
    ...
    chapters: [
      ...
      {
        eyebrow: 'Forever',
        heading: 'Forever on Palm',
        body: "Asked how long she had been on Palm, Gurtrude answered with one word. The line is short because the answer is.",
        pullquote: "Forever.",
        attribution: 'Gurtrude Grace Richardson · Elders Trip Interview',
        bg: BG.palmHappyMoments1935,
      },
      ...
      {
        eyebrow: 'Choice',
        heading: 'I chose myself',
        body: "Gurtrude on resilience as a deliberate decision — not following the path her mother walked. The line is intelligible in transcript; the words around it fragment under audio quality. Pending re-listen pass before any further surface.",
        pullquote: "I chose in my myself.",
        attribution: 'Gurtrude Grace Richardson · Elders Trip Interview',
        bg: BG.palmIsland1928,
      },
    ],
